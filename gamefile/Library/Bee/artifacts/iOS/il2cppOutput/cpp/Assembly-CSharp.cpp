...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerAttack_Update_m372F24A844F59854A74FBA6B78AE603C429B1AAE (PlayerAttack_tD31821DD3D999BDE1753E525C8D48C67269B2178* __this, const RuntimeMethod* method) 
{
	...
	{
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_0 = __this->___attackingPos;
		float L_1 = __this->___attackDirX;
		float L_2 = __this->___attackDirY;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3;
		memset((&L_3), 0, sizeof(L_3));
		...
		L_7 = PhysicsUtil_RefrectionLinePoses_mC3BAD556984ADF15D31C21F7EA9DE084B629616C(L_0, L_4, L_5, L_6, NULL);
		NullCheck(L_7);
		...
		NullCheck(L_10);
		NullCheck(L_9);
		LineRenderer_set_positionCount_m2001FB4044053895ECBE897AB833284F3300B205(L_9, ((int32_t)(((RuntimeArray*)L_10)->max_length)), NULL);
		...
		NullCheck(L_11);
		LineRenderer_SetPositions_m7F7B7B54428437D0BF5256D4C82F92180B577B02(L_11, L_12, NULL);
...
IL_0063:
	{
		...
		NullCheck(L_15);
		bool L_16 = L_15->___isStickMoving;
		if (!L_16)
		{
			goto IL_0087;
		}
	...
	}
	{
		...
		V_2 = L_18;
		Touch_t03E51455ED508492B3F278903A0114FA0E87B417 L_19 = V_2;
		PlayerAttack_GetSwipe_m9131C8E13BFC4A9E400662AADC0531A6932EF707(__this, L_19, NULL);
		return;
	}
...
IL_0087:
	...
	{
		bool L_21 = __this->___isStickPressed;
		if (!L_21)
		{
			goto IL_0098;
		}
...
IL_0098:
	{
		...
		V_3 = L_22;
		Touch_t03E51455ED508492B3F278903A0114FA0E87B417 L_23 = V_3;
		PlayerAttack_GetSwipe_m9131C8E13BFC4A9E400662AADC0531A6932EF707(__this, L_23, NULL);
	}
...
{
	{
		...
		__this->___attackDirX = (0.0f);
		__this->___attackDirY = (0.0f);
		__this->___isAttacking = (bool)0;
